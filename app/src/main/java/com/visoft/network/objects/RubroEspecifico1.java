...
public class RubroEspecifico1 extends AbstractFlexibleItem<ViewHolderRubro> implements Serializable {

    private ArrayList<RubroEspecifico2> subRubros;
    private String nombre;
    private String id;

    public RubroEspecifico1(Context context, String id) {
        this.id = id;
        ...
        for (String a : subRubrosID) {
            subRubros.add(new RubroEspecifico2(context, a));
        }
    }
    ...
    public ArrayList<RubroEspecifico2> getSubRubros() {
        return subRubros;
    }
