...
public class ProUserFragment extends Fragment implements OnMapReadyCallback, View.OnClickListener {
    ...
    private void iniciarUI() {
        ...
        if (getActivity() instanceof OwnUserProfileActivity) {
            ...
            messenger = new Messenger(getContext(), FirebaseAuth.getInstance().getCurrentUser().getUid(), user.getUid(), (ViewGroup) getView().findViewById(R.id.rootView), containerScreens, database);
        }
